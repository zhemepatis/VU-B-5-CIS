...
m1 = 'iskelta veliava' # pirma zinute
[gamma, delta_1]=[3757359024922607955461127104540918427850, 2657744583164683453615599287262487940731] # pirmas parasas

m2 = 'smagus darbas' # antra zinute
[gamma, delta_2]=[3757359024922607955461127104540918427850, 1824601941863231577635399491545820671789] # antras parasas
...
k = 4055
power_mod(g, k, p) == gamma

# a * gamma = x2- delta_2*k mod (p - 1)
a = (x2 - delta_2*k) / gamma % pm
a = 317

power_mod(g, a, p) == beta

i_teksta(C_2 * power_mod(C_1, -a, p) % p)
